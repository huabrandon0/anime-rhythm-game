# *Your Name*: A Rhythm Game (CS 174A Final Project) 
## Introduction
...
Many of the special effects and animations are done using custom shaders. For example, the notes look like they are being carried along a conveyer belt of sorts; this is done through a scrolling texture shader (as we worked with in one of the homeworks).
